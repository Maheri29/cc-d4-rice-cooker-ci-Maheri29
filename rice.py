...
def choisir_mode(choix_input=input, temps_personnalise_input=input, alerte_input=input):
    ...
    choix = choix_input('Choisissez un mode de cuisson (1/2/3/4) : ')
    ...
    if choix == '1':
        ...
        temps_personnalise = int(temps_personnalise_input("Entrez le temps de cuisson en secondes pour l'autre aliment : "))
    ...
    if temps_cuisson > 0:
        ...
        choix_alerte = alerte_input('Choisissez le type d\'alerte pour signaler la fin de la cuisson (1/2) : ')
        ...
        choix_apres_cuisson = choix_input('Que voulez-vous faire maintenant? (1. Éteindre / 2. Maintenir au chaud) : ')
